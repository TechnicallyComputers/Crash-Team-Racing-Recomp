...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "CRASH_TEAM_RACING_RECOMP_PROJECT_ROOT",
    .build_dir_env = "CRASH_TEAM_RACING_RECOMP_BUILD_DIR",
    .force_setup_env = "CRASH_TEAM_RACING_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_944.26_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Crash_Team_Racing__Recompiled",
    .prepare_note =
